...
const styles = {
  ...
  subheader: 'px-3 pb-3 text-xs text-text-muted',
  tabRow: 'flex gap-1.5 px-3 pb-3',
  ...
  contextLine: 'px-3 pb-4 text-xs text-text-muted',
  ...
  emptyState: 'flex flex-col items-center py-16 text-center px-3',
